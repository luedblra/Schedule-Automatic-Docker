...
class CoscoRoutesForCitiesJob implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;
    protected $id,$arreglo,$idcj;
    public $insertSubRt;
    /**
     ...
     * @return void
     */
    public function __construct($id,$arreglo,$idcj)
    {
        $this->id       = $id;
    ...
    public function handle()
    {
        ...
        $cityFrom = CoscoCity::find($this->id);
        $citiesTo = $this->arreglo;
